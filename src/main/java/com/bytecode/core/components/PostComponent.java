...
public class PostComponent {
	...
	public List<Post> getPosts(){
		...
		post.add(new Post(1,"El desarrollo web es un proceso complejo que implica la creación de productos digitales en línea.","http://localhost/img/post.JPG", new Date(),"1_Desarrollo WEB"));
